...
class Carguehemofiliacontrollers {
    guardarEncabezadoProcesoHemofilia(req, res) {
        ////////////////Guardar proceso hemofilia encabezado/////////////////////////
        DbProcesoHemofilia_1.default.guardar(req.body, function (result) {
                    ...
                    try {
                        ...
                        if (arraycamposbuenos.length == result.length) {
                            ...
                            for (let i = 0; i <= arraycamposmalos.length; i++) {
                                ...
                                database_1.default.query('insert into  bd_proceso_hemofilia_error set ?', [arraycamposmalos[i]]);
                            }
                        }
                    }
                    catch (error) {
